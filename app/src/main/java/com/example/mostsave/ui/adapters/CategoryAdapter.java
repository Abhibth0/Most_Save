...
public class CategoryAdapter extends ListAdapter<Category, CategoryAdapter.CategoryViewHolder> {
    ...
    private Map<Integer, Integer> passwordCountMap = java.util.Collections.emptyMap();

    public void setPasswordCountMap(Map<Integer, Integer> passwordCountMap) {
        this.passwordCountMap = passwordCountMap;
    ...
    public void onBindViewHolder(@NonNull CategoryViewHolder holder, int position) {
        ...
        int count = passwordCountMap.getOrDefault(currentCategory.id, 0);
        holder.bind(currentCategory, renameListener, deleteListener, count);
    ...
    static class CategoryViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView textViewPasswordCount;
        ...
        public CategoryViewHolder(@NonNull View itemView) {
            ...
            textViewPasswordCount = itemView.findViewById(R.id.text_view_password_count);
        ...
        public void bind(final Category category, final OnCategoryRenameListener renameListener, final OnCategoryDeleteListener deleteListener, int passwordCount) {
            textViewCategoryName.setText(category.getName());
            textViewPasswordCount.setText(String.valueOf(passwordCount));
